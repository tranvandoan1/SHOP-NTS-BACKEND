...
router.post("/signup", upload.single("files"), async (req, res) => {
    ...
    } else if (isPhoneNumber(req.body.phone) == false) {
        return res.json({
                ...
                if (err) {
                    ...
                    if (req.file !== undefined) {
                        ...
                        const fileMetadata = {
                            ...
                            parents: ["1T-VV37Gbkryfqzfc8C7ydTzb6HOuQimB"],
                        };
                        const media = {
                        ...
                        const newUser = {
                            ...
                            email: req.body.email,
                            hashed_password: password,
                            avatar: `https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/OOjs_UI_icon_userAvatar-constructive.svg/2048px-OOjs_UI_icon_userAvatar-constructive.svg.png`,
                            phone: req.body.phone,
                            image_id: 1,
                        };
                        const user = new Users(newUser);
